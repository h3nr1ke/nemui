...
export class NemuiPanel implements vscode.Disposable {
    ...
    private getHtml(): string {
        ...
        const indexPath = path.join(this.context.extensionPath, 'webview', 'index.html');
        ...
        if (fs.existsSync(indexPath)) {
            ...
            // Replace absolute paths with webview URI
        ...
        // Fallback HTML if files not found
        return `
<!DOCTYPE html>
<html lang="en">
<head>
